...
module.exports = async done => {
  ...
  while(true) {
    const response = await CoinGeckoClient.coins.fetch('bitcoin', {}); //get the price of bitcoin from coingecko
    let currentPrice = parseFloat(response.data.market_data.current_price.usd); //allow to have the USD price
